        ...
        <div class="row m-5">
            ...
            <div class="col-md-9 ms-auto text-end">
                <button type="button" class="px-4 p-2 rounded shadow" style="background-color: #A7C3F9; border:none;">
                    ...
                    <a href="/RecycleHistory" style="text-decoration: none; color: black"><span class="ms-2"><b>History</b></span></a>
                </button>
                ...
                <button type="button" class="px-4 p-2 ms-5 rounded shadow" style="background-color: #03C043; border:none;">
                    ...
                    <a href="/InsertRecycleConsumption" style="text-decoration: none; color: black"><span class="ms-2"><b>Add Bills</b></span></a>
                </button>
            </div>
        </div>
    </div>
        ...
        <div class="row m-5">
            ...
            <div class="col-md-4 d-flex flex-column justify-content-between">
                <div class="bg-white p-4 px-5 rounded shadow m-3 text-center"><!--current water consumption section-->
                    <img src="images/recycle.png" alt="Current Water Consumption" width="80" height="75">
                    <div class="d-flex flex-column align-items-center justify-content-center mb-3">
                        <span class="mt-2">Current Recycle Collection (kg)</span>
                        <h1 class="mt-auto mb-0"><b>35</b></h1>
                    </div>
                </div>
                ...
                <div class="bg-white p-4 px-5 rounded shadow m-3 text-center"><!--carbon footprint section-->
                    ...
                    <div class="d-flex flex-column align-items-center justify-content-center">
                        <span class="mt-2">Carbon Footprint (kg CO<sub>2</sub>)</span>
                ...
                <button type="button" class="p-2 mx-5 m-3 rounded shadow text-center" style="background-color: #A3FF6B; border:none;"><!--download report section-->
                    ...
                    <a href="/RecycleDownloadReport" style="text-decoration: none; color: black"><span class="ms-2"><b>Download Report</b></span></a>
                </button>
            </div>
            ...
            <div class="col-md-8">
                <div class="bg-white p-4 px-5 rounded shadow m-3"><!--details section-->
                    <h3 class="text-center mb-4 mt-2"><b>Recycle Record</b></h3>
                    <div class="row mb-4">
                    ...
                    <div class="row mb-5">
                        <div class="col-md-5"><b>Current Recycle Collection (kg):</b></div>
                    ...
                    <div class="row mt-4 text-end">
                        <div class="col mb-3"><b>Carbon Footprint (kg CO<sub>2</sub>): 14.665</b></div>   
                    </div>
                </div>
            </div>
        </div>
