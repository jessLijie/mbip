        ...
        <form action="insertWaterController" method="post" target="_self">
            <div class="bg-white p-4 px-5 rounded shadow m-3"> 
                ...
                <div class="row mb-4 align-items-center">
                    ...
                    <div class="col-md-4">
                        <input type="text" id="postcode" name="postcode" pattern="[0=9]" maxlength="5" value="" class="form-control" required><!--retrieve postcode-->
                    </div>
                </div>
                ...
                <div class="text-center mt-4">
                    <a href="#"><button type="submit" class="btn btn-lg px-5" style="background-color: #4C8BC6; color: white;"><b>SUBMIT</b></button></a>
                </div>
            </div>
        </form>
    </div>    
