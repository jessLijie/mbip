...
<body style="background-color: #CCF3EA">
    <div class="container-fluid"><!--button container-->
        <div class="row m-5">
            <div class="col-auto" onclick="window.location.href='/InsertWaterConsumption';">
            ...
            <div class="col-md-9 ms-auto text-end">
                <button type="button" class="px-4 p-2 rounded shadow" style="background-color: #A7C3F9; border:none;">
                    ...
                    <a href="/WaterHistory" style="text-decoration: none; color: black"><span class="ms-2"><b>History</b></span></a>
                </button>
                ...
                <button type="button" class="px-4 p-2 ms-5 rounded shadow" style="background-color: #03C043; border:none;">
                    ...
                    <a href="/InsertWaterConsumption" style="text-decoration: none; color: black"><span class="ms-2"><b>Add Bills</b></span></a>
                </button>
            </div>
        </div>
    </div>
        ...
        <div class="row m-5">
            ...
            <div class="col-md-4 d-flex flex-column justify-content-between">
                <div class="bg-white p-4 px-5 rounded shadow m-3 text-center"><!--current water consumption section-->
                    ...
                    <div class="d-flex flex-column align-items-center justify-content-center mb-3">
                        <span class="mt-2">Current Water Consumption (m<sup>3</sup>)</span>
            ...
            <div class="col-md-8">
                <div class="bg-white p-4 px-5 rounded shadow m-3"><!--details section-->
                    ...
                    <div class="row mb-5">
                        <div class="col-md-5"><b>Current Consumption Value (m<sup>3</sup>):</b></div>
