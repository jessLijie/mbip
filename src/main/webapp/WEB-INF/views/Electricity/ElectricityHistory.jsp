          ...
          <div class="outcontainer2">
            <table class="tablehistory">
              <thead>
                ...
                <td class="col4">
                  <a  style="text-decoration: none;" href="/electricity/Electricity"
                    ><svg
                  ...
                  <div class="filter">
                    <button id="showFilter"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35"
                      ...
                      <div class="filteryear">
                        <button id="leftArrowYear">
                          <svg xmlns="http://www.w3.org/2000/svg" width="12" height="14" viewBox="0 0 12 14"
                            fill="none">
                            <path d="M9.72973 0L12 1.63333L4.54054 7L12 12.3667L9.72973 14L0 7L9.72973 0Z"
                              fill="#243E69" />
                          </svg>
                        </button>
                        ...
                        <button id="rightArrowYear">
                          <svg xmlns="http://www.w3.org/2000/svg" width="11" height="14" viewBox="0 0 11 14"
                            fill="none">
                            <path d="M2.08108 14L0 12.3667L6.83784 7L0 1.63333L2.08108 0L11 7L2.08108 14Z"
                              fill="#243E69" />
                          </svg>
                        </button>
                      </div>
                ...
                <c:forEach var="electricity" items="${electricityList}" varStatus="status">
                  <tr>
                    ...
                    <td class="button">
                      ...
                      <a href="/electricity/ElectricityUpdateBill?billId=${electricity.id}">
                        <button class="viewdetailbutton">
