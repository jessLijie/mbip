...
<jsp:include page="../navbar.jsp"/><body style="background-color: #CCF3EA">
    <button type="button" class="px-4 p-2 m-4 mb-0 ms-5 rounded shadow"  onclick="window.location.href='/ElectricityHistory;' "style="background-color: #A7C3F9; border:none; ">
    ...
    <div class="container mt-2 justify-content-center" style="width: 60%">
        <form action="/ElectricityFootprint" method="post" target="_self">
            <div class="bg-white p-4 px-5 rounded shadow m-3"> 
                ...
                <div class="text-center mt-4">
                    <a href="/ElectricityFootprint"><button type="submit" class="btn btn-lg px-5" style="background-color: #4C8BC6; color: white;"><b>SUBMIT</b></button></a>
                </div>
            </div>
        </form>
    </div>    
