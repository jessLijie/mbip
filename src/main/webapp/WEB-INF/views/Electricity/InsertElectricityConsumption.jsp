...
<html>
    ...
    <body style="background-color: #CCF3EA">
        <button type="button" class="px-4 p-2 m-4 mb-0 ms-5 rounded shadow"
        ...
        <div class="container mt-2 justify-content-center" style="width: 60%">
            <form action="/electricity/InsertElectricityConsumption"
                method="post">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-10">
                            <input type="text" id="address1" name="address1"
                                value class="form-control mb-3"
                                required><!--retrive address1-->
                            <input type="text" id="address2" name="address2"
                                value class="form-control"
                                required><!--retrive address2-->
                        </div>
                    </div>
